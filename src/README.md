...
## Вопросы:
Сложности с написанием кода у меня возникли только когда дошла до реализации класса VeterinaryClinic.
Честно подсмотрела реализацию в записи с семинара.